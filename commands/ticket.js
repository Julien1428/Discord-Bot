...
module.exports = {
    run: async (message, args, client) => {
        ...
        channel.send(new Discord.MessageEmbed()
                .setColor('#00ff21')
            .setDescription(`Bonjour ${message.member}, bienvenue dans votre ticket, un staff va s\'occuper de vous.`))
        message.channel.send(`Votre ticket ${channel} a été créé !`)
    },
    name: 'ticket',
    guildOnly: true,
    help:{
        description: "si tu as besoin d\'aide les staff sont la pour t'aider"
    }
}